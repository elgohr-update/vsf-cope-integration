module.exports = {
  title: 'Vue Storefront 2 for cope',
  base: '/',
  description: 'Documentation for the cope connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/cope',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/cope'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/cope'}
    ],
    sidebar: [
      {
        title: 'Essentials',
