...
```sh
grep -rl 'cope' ./ | xargs sed -i '' 's/cope/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with cope
...
Want to contribute? Ping us on `cope` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/cope.git
    cd cope
    ```
...
- [cope integration Documentation](https://docs.vuestorefront.io/cope)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `cope` channel on [our Discord](discord.vuestorefront.io).
